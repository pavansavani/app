  ...
  const detailedFeatures = [
    {
      ...
      description: "Easy and secure login with your Google account – no passwords to remember!"
    },
    {
      icon: "📂",
      title: "Organized Tabs",
      description: "Three clear categories: Websites, Apps, and Notes for perfect organization."
    },
    {
      icon: "⚡",
      title: "Quick Management",
      description: "Add and delete items instantly with simple, intuitive controls."
    },
    {
      icon: "🔍",
      title: "Search & Sort",
      description: "Find your data fast with powerful search and smart sorting options."
    },
    {
      icon: "👁️",
      title: "Masked Passwords + Copy",
      description: "Passwords hidden by default with handy copy button for security and convenience."
    },
    {
      icon: "⏰",
      title: "Timestamps & Auto-save",
      description: "Track when items were added and never lose data with automatic saving."
    },
    {
      icon: "📱",
      title: "Responsive Design",
      description: "Clean, modern UI that works perfectly on both mobile and desktop devices."
    },
    {
      icon: "🌗",
      title: "Dark/Light Mode",
      description: "Switch between themes for the perfect viewing experience anytime."
    }
  ];

  const FeaturesModal = () => {
    if (!showFeaturesModal) return null;
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 rounded-t-2xl">
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white">MindBox Features</h3>
              <button
          ...
          <div className="p-6">
            ...
            <div className="mt-8 text-center">
              <button
                ...
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
